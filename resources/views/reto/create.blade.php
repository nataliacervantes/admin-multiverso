...
@section('content')
  <section id="main-content">
    <section class="wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-file-text-o"></i> Reto</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
                {!! Form::open(['url'=>'guardarReto', 'class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                  <div class="form-group">
                    {!! Form::label('Reto','Nombre del Reto', ['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-10">
                      {!! Form::text('Reto', '', ['class'=>'form-control']) !!}
                    </div>
                  </div>
                  <div class="form-group">
                    {!! Form::label('Descripcion','Descripción del Reto', ['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-10">
